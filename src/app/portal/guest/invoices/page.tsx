...
export default async function GuestInvoicesPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <PortalTopbar title="My Receipts & Invoices" />
      <div className="flex-1 p-4 sm:p-6 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-100 font-bold text-gray-900 text-[14px]">Invoices & Receipts</div>
          {invoices.length === 0 ? (
            <div className="text-center py-16">
              <div className="text-4xl mb-3">🧾</div>
              <div className="text-[15px] font-bold text-gray-700">No Invoices Yet</div>
              <div className="text-[12px] text-gray-400 mt-1">Your booking invoices will appear here once issued.</div>
            </div>
          ) : (
